      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Find proofs, templates, and users with powerful search capabilities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Search History */}
            <SearchHistory onSearchSelect={handleSearch} onClearHistory={clearSearch} limit={5} />

            {/* Saved Queries */}
            <SavedQueries onSearchSelect={handleSearch} />
          </div>
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-start">
                        <div className="flex-shrink-0 mr-4">{getResultTypeIcon(result.type)}</div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between text-sm text-gray-500">
                            <div className="flex items-center space-x-4">
                              ...
                              {result.rating && <span>Rating: {result.rating.toFixed(1)}/5</span>}
                              {result.price && <span>Price: {result.price} XLM</span>}
                            </div>
