          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <select
                ...
                onChange={(e) =>
                  setVerificationData((prev) => ({ ...prev, proofType: e.target.value }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setVerificationData((prev) => ({ ...prev, credentials: e.target.value }))
                }
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-base"
              />
            </div>
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 5 5 0 011.905.884A5 5 0 0117 16H7zm4 0v1a1 1 0 011 1h2a1 1 0 011-1V5a1 1 0 011-1H7a1 1 0 00-1 1v10a1 1 0 001 1h2a1 1 0 001-1V5z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M15 12a3 3 0 11-6 0v6a3 3 0 016 0h-2a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2V6a3 3 0 01-2-2z"
                  />
                </svg>
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 11c0 3.517-1.009-6.512-6.512S5.483 0 12 11s6.512 6.512 6.512 6.512m0 0c0 3.517 1.009 6.512 6.512 6.512M12 14v7m0 0l6 7m-6-7v7m6 7v-7"
                  />
                </svg>
              ...
              <div className="flex items-center mb-4">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M9 12l2 2 4-4m6 2a2 2 0 012-2v-4a2 2 0 00-2 2m-6 9l2 2 4-4m6 2a2 2 0 012-2v-4a2 2 0 00-2 2"
                  />
                </svg>
                <div>
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {verificationData.proofType || 'Not selected'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Documents:</span>
                  <span className="font-medium">
                    {verificationData.documents?.length || 0} files
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Biometric:</span>
                  <span className="font-medium">
                    {verificationData.biometricData?.scanned ? 'Scanned' : 'Not scanned'}
                  </span>
                </div>
              </div>
            </div>
              ...
              <span className="flex items-center">
                ...
                >
                  ...
                  <path
                    ...
                    fill="currentColor"
                    d="M4 12a8 8 0 018-8v8H4V6a6 6 0 00-6-6h2a2 2 0 002 2v2a2 2 0 002 2v2a2 2 0 002-2V6a2 2 0 00-2-2H4a6 6 0 00-6 6v8z"
                  ></path>
                </svg>
                Processing...
              </span>
