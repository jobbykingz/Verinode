...
const FormBuilder: React.FC = () => {
  ...
  const addFieldToForm = useCallback(
    (fieldType: FieldType, index: number) => {
      if (!state.template) return;
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      if (state.template.id) {
        savedTemplate = await formBuilderService.current.updateTemplate(
          state.template.id,
          state.template,
        );
      } else {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div
        className={`w-80 bg-white border-r border-gray-200 transition-all duration-300 ${showFieldLibrary ? 'translate-x-0' : '-translate-x-full'}`}
      >
        <FieldLibrary
                  ...
                  <div className="w-96 bg-white border-l border-gray-200 p-6 overflow-y-auto">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateField(state.selectedField!.id, { label: e.target.value })
                              }
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateField(state.selectedField!.id, { name: e.target.value })
                              }
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateField(state.selectedField!.id, {
                      ...
                      <ValidationRules
                        ...
                        onUpdate={(rules) =>
                          updateField(state.selectedField!.id, { validationRules: rules })
                        }
                      />
                      ...
                      <ConditionalLogic
                        ...
                        onUpdate={(logic) =>
                          updateField(state.selectedField!.id, { conditionalLogic: logic })
                        }
                      />
                    </div>
                  </div>
