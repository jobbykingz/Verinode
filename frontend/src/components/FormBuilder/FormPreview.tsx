          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-2 rounded-lg text-sm transition-colors ${
                showValidation ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'
              }`}
            >
        ...
        <div className={getDeviceStyles()}>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="px-6 py-6 border-b border-gray-200">
              <h1 className="text-2xl font-bold text-gray-900 mb-2">{template.settings.title}</h1>
            ...
            {/* Form Footer */}
            {template.settings.confirmationMessage &&
              submitted &&
