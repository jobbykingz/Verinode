      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Stellar Soroban resource analysis and optimization
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-6 rounded-3xl hover:border-emerald-500/30 transition-all cursor-default relative overflow-hidden"
            >
              <div
                className={`absolute -right-4 -top-4 w-24 h-24 bg-gradient-to-br ${stat.color} opacity-5 blur-2xl group-hover:opacity-10 transition-opacity`}
              />
              <div className="flex items-center space-x-4">
                <div
                  className={`p-3 rounded-2xl bg-gradient-to-br ${stat.color} opacity-90 shadow-lg`}
                >
                  {stat.icon}
                </div>
                <div>
          ...
          <div className="space-y-8">
            <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 p-6 rounded-3xl text-center relative overflow-hidden group">
              ...
              <div className="relative inline-flex items-center justify-center p-8 group-hover:scale-110 transition-transform">
                <svg className="w-32 h-32 transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeDashoffset={2 * Math.PI * 58 * (1 - optimizationScore / 100)}
                    stroke="currentColor"
                    fill="transparent"
                    r="58"
                    cx="64"
              ...
              <p className="mt-6 text-sm text-slate-400 font-light leading-relaxed">
                ...
                <span className="text-emerald-400 font-bold">12.5%</span> more efficient than the
                global network average.
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    desc: 'Batch 4 operations in ProofService',
                    level: 'High',
                  },
                  {
                    title: 'Storage Layout',
                    desc: 'Compress metadata binary blobs',
                    level: 'Medium',
                  },
                  ...
                  <div
                    key={i}
                    className="p-4 bg-slate-900/50 rounded-2xl border border-slate-700/30 hover:border-emerald-500/20 transition group cursor-pointer"
                  >
